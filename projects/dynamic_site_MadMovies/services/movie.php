...
$query = "SELECT movie_id, name, rating, hour_me, minute_me, category_id, date_me, descript, country_id, language_id, colour_id, didyouknow, cover_id, youtube
FROM movie
